...
<nav class="navbar navbar-default">
    <div class="container">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#main-collapse-nav">
...
<section class="footer">
    <p class="copyright text-center">
        &copy; <?= date('Y'); ?> <a href="http://neoelemento.com">neoelemento</a>. All rights reserved.
    </p>
</section>
<!-- Scripts -->
